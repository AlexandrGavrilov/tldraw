...
export declare enum TLPerformanceMode {
...
export declare type TLAssets = Record<string, TLAsset>;
...
export declare type TLDropEventHandler = (e: React.DragEvent<Element>) => void;
