...
export declare function Tldraw({ id, document, currentPageId, autofocus, showMenu, showMultiplayerMenu, showPages, showTools, showZoom, showStyles, showUI, readOnly, disableAssets, darkMode, showSponsorLink, onMount, onChange, onChangePresence, onNewProject, onSaveProject, onSaveProjectAs, onOpenProject, onOpenMedia, onSignOut, onSignIn, onUndo, onRedo, onPersist, onPatch, onCommand, onChangePage, onAssetCreate, onAssetDelete, onAssetUpload, onSessionStart, onSessionEnd, onExport, }: TldrawProps): JSX.Element;
