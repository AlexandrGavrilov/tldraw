...
import { TDDocument, AlignType, StretchType, DistributeType, ShapeStyles, TDShape, TDShapeType, TDSnapshot, TDPage, TDBinding, TldrawCommand, TDUser, SessionType, TDToolType, TDAsset, TDAssets, TDExport, TDExportType, TldrawPatch } from '../types';
...
export declare class TldrawApp extends StateManager<TDSnapshot> {
     ...
     * Set a setting.
     */
    setSetting: <T extends "language" | "isDarkMode" | "showGrid" | "isSnapping" | "isCadSelectMode" | "isDebugMode" | "isPenMode" | "isReadonlyMode" | "isZoomSnap" | "keepStyleMenuOpen" | "nudgeDistanceSmall" | "nudgeDistanceLarge" | "isFocusMode" | "showRotateHandles" | "showBindingHandles" | "showCloneHandles" | "dockPosition", V extends {
     ...
     */
    cancel: () => this;
    addMediaFromFile: (file: File, point?: number[]) => Promise<this>;
